...
function Hologram_Clipping(baseModel) {
    ...
    const plane_left = new THREE.Plane(new THREE.Vector3(-1,0,0),-8.5);
    const plane_right = new THREE.Plane(new THREE.Vector3 (1,0,0),-8.5);
    const plane_top = new THREE.Plane(new THREE.Vector3(0,1,0),0)
    const plane_bottom = new THREE.Plane(new THREE.Vector3(0,-1,0),0)

    const plane_centre_left = new THREE.Plane(new THREE.Vector3 (1,0,0),8.5);
    const plane_centre_right = new THREE.Plane(new THREE.Vector3 (-1,0,0),8.5);
    ...
    line_right = new THREE.PlaneHelper(plane_right, 10, 0x00ff00); 
    line_top = new THREE.PlaneHelper(plane_top, 10, 0x0000ff); 
    line_bottom = new THREE.PlaneHelper(plane_bottom, 10, 0x0000ff); 
